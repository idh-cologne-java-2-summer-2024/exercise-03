...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Ich packe in meinen Koffer ein Netzteil für mein Telefon und eine Wasserflasche und ein Telefon und meine Crocks und eine Wasserflasche und meine Zahnbürste.");
